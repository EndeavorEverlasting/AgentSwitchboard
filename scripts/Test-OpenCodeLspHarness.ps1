...
if (-not ([string]$manifest.runtimeRecovery.proofRule).ToLowerInvariant().Contains('version-healthy')) { [void]$failures.Add('manifest-runtime-recovery-version-health-selection-missing') }
