...
$blockedPatterns = @(
    ...
    'pi-workstation-prereqs.json',
    'pi-workstation-prereqs.md',
    'pi-harness-status.json',
    'pi-harness-status.md',
    'pi-system-bootstrap.json',
    'pi-system-bootstrap.md',
    'pi-events.jsonl',
    'pi-stderr.txt',
    'child-result.json',
    'child-result.md'
...
Write-Host 'PASS: Pi harness completeness, system/child contracts, staged diff hygiene, and generated-evidence exclusion.' -ForegroundColor Green
exit 0
