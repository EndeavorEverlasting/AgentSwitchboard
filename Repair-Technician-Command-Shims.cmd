...
title Technician Live-Cert Repair Command Shims
cd /d "%~dp0"
set "REPAIR_DISPATCHER=%~dp0tooling\profiles\windows\technician-live-cert\Invoke-TechnicianRepair.ps1"
pwsh.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%REPAIR_DISPATCHER%" -RepairId Command-Shims -RepoRoot "%~dp0" %*
