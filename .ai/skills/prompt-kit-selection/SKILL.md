...
Do not use this skill merely because the word ΓÇ£promptΓÇ¥ appears. Ordinary writing and repository execution remain governed by their direct task contracts.
...
4. Confirm the promptΓÇÖs `useThisWhen`, `doNotUseWhen`, `promptClass`, mutation authority, proof ceiling, and required variables.
...
- preserve the registryΓÇÖs regular-AI versus GNHF boundary;
