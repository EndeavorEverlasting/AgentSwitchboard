...
- **Last proof:** merge:1b1c65c14a8cc64d4665a07eded23178286f66b3 pr:#221 INTEGRATED runbook exit-50 pin from upstream-pin.json; prior merge:0a57a41fa09cefb9f74994010363230306138ff0 pr:#219 Asq017 child-NEXT prefer + paste pin-from-JSON; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `1b1c65c`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
