...
- **Last proof:** merge:0a57a41fa09cefb9f74994010363230306138ff0 pr:#219 INTEGRATED Asq017 prefer child NEXT= + paste pin-from-JSON; prior merge:b6d83654ebe0eb562c45392350027652e6babaef pr:#217 Asq017 pin reload after ff-only refresh; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `0a57a41`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
