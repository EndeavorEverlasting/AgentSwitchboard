...
- **Branch / PR:** chore/work-ledger-post-merge-state-20260809 / #106
...
- **Next action:** merge PR #106 at its exact green head; after merge, update ASQ-001 to DONE only if no additional safe actionable work remains
