...
- **Dependencies:** FM-BRIDGE-10 / PR #177 bounded repair authority; PR #178 continuation entrypoint on main; PR #183 durable `Invoke-Asq017AdminBoxLiveFloor.ps1` on main; PR #189 Admin Box `NEXT=` surface + passwordless-sudo preflight on main; PR #192 apt-scoped sudo probe + exit 47 BLOCKED_SUDO propagation on main; primary-harness early preflight exit 48 + child `NEXT=` preservation pending merge on this tip
...
- **Last proof:** merge:6e03b48c815286e8ee92810be72932675850f111 pr:#192 INTEGRATED apt-scoped passwordless-sudo probe + persisted sudo diagnostics + exit 47 `BLOCKED_SUDO` through FM-WSL-12/ASQ-017 wrappers; prior merge:21a6a80b068f712bb553468072175031e308a9b0 pr:#189 NEXT= surface; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED retained; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
