...
- **Last proof:** tip-cite ContractOnly PASS + live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `4e884b1` after #268 (paste/runbook exit-1 STATUS guidance); prior merge:28414c757c8b4f477fb149560db136fec564ea65 pr:#266 preserve child STATUS=BLOCKED_*; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
