...
- **Last proof:** tip-cite ContractOnly PASS + live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `2562b92` after #274/#275/#276 (early wiring→52, harness preserve child exits, contract-only Python check); prior tip `2a72020`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
