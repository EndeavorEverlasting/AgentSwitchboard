...
- **Last proof:** merge:c04abd4460363102cb7cbc52ca1b8d1f5aeec2f6 pr:#250 INTEGRATED Asq017/oneshot harness-start + FirstMate-pin and bridge/PhysicalFloor prerequisite-timeout structured exits; prior merge:5b6cc7f5fe9df65f51a5c32a780351b271c5be92 pr:#249 tip-cite for #248; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `c04abd4`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
