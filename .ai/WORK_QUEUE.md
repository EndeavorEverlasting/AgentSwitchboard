...
- **Last proof:** merge:c0512e3b9ae924871baeb899db1acbe02f32f71c pr:#213 INTEGRATED PhysicalFloor FirstMate pin from `upstream-pin.json` (no hardcoded SHA in preflight); prior merge:8b958afda69f29433e12fe131af49bc3ecd2008e pr:#211 bridge structured exits 51/52; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `c0512e3`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
