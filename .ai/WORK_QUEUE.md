...
- **Last proof:** merge:3babc659eaf851cc8ce607b147291abcace4c407 pr:#183 INTEGRATED durable `Invoke-Asq017AdminBoxLiveFloor.ps1` on main; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED retained; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required; Ubuntu FirstMate pin `b182d0f908b78d08c7ccb8dce3775bdca8c5d657` + one primary harness + Ubuntu `gh` auth remain operator pre-stage for PASS
