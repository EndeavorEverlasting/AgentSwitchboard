...
- **Last proof:** merge:c473b26c9f852a8aa2f5ad695cc232125772e4be pr:#215 INTEGRATED Asq017/oneshot exit-50 NEXT pin from `upstream-pin.json` (no hardcoded SHA in Admin Box fallbacks); prior merge:c0512e3b9ae924871baeb899db1acbe02f32f71c pr:#213 PhysicalFloor pin-from-JSON; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `c473b26`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
