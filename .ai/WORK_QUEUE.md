...
- **Last proof:** merge:0c59070d06aa72aceb073ffa659aa52f812ba3a9 pr:#259 INTEGRATED oneshot contract/continue exit-124 → STATUS=BLOCKED_PREREQUISITE_TIMEOUT; prior merge:1410e77ff0835ea9a368cc570e8881d38f7eb6ab pr:#257 ContractOnly STATUS=CONTRACT_FAIL; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `0c59070`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
