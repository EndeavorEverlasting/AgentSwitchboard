...
- **Dependencies:** FM-BRIDGE-10 / PR #177 bounded repair authority; PR #178 continuation entrypoint on main; PR #183 durable `Invoke-Asq017AdminBoxLiveFloor.ps1` on main; PR #189 Admin Box `NEXT=` surface + passwordless-sudo preflight on main; PR #192 apt-scoped sudo probe + exit 47 BLOCKED_SUDO propagation on main; PR #194 primary-harness early preflight exit 48 + child `NEXT=` preservation on main; FirstMate dirty/pin early preflight exits 49/50 pending merge on this tip
...
- **Last proof:** merge:0b5e39405405b3dfd1a4ba79ff17ab5361fb184b pr:#194 INTEGRATED primary-harness early preflight exit 48 `BLOCKED_PRIMARY_HARNESS` + child `NEXT=` preservation + contract/runbook/ASQ-017 paste for 45/47/48; prior merge:6e03b48c815286e8ee92810be72932675850f111 pr:#192 exit 47 `BLOCKED_SUDO`; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED retained; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
