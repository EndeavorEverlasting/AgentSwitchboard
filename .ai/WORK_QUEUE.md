...
- **Last proof:** merge:7eb97451ff0286f5c43c5f85cd79ee189933268d pr:#198 INTEGRATED `-FirstMatePath` physical-floor dirty/pin override via `WSLENV`/`ASB_FIRSTMATE_PATH` (skips `$HOME/firstmate`); prior merge:c8556dd4a65d43bf198341c20804e6d05d1f7938 pr:#196 exits 49/50; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `7eb9745`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
