...
- **Last proof:** merge:40c2c6c211d9f16e5fa46b95aff4333d000c23e2 pr:#262 INTEGRATED oneshot protected-control exit-124 → STATUS=BLOCKED_PREREQUISITE_TIMEOUT; prior tip-cite ContractOnly+exit46 on `af7f013`; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `40c2c6c`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
