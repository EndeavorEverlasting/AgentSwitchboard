...
- **Dependencies:** FM-BRIDGE-10 / PR #177 bounded repair authority; PR #178 continuation entrypoint on main; PR #183 durable `Invoke-Asq017AdminBoxLiveFloor.ps1` on main
...
- **Last proof:** merge:2cb373fa66d3cc7bf07775415f6f58a0fcf30cc9 pr:#187 INTEGRATED bounded FirstMate pin bootstrap + `-FirstMatePath` on `Invoke-Asq017AdminBoxLiveFloor.ps1`; prior merge:3babc659eaf851cc8ce607b147291abcace4c407 pr:#183 durable floor on main; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED retained; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required; primary harness + Ubuntu `gh` auth remain operator pre-stage for PASS
