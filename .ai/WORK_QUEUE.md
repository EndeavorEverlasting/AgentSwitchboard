...
- **Last proof:** merge:be44bc1dc3088bd2923439e0154d7886256b6e79 pr:#264 INTEGRATED continuation exit→STATUS map + BLOCKED_CONTINUATION_EXHAUSTED fallthrough; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip ; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
