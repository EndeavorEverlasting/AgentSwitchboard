...
- **Last proof:** merge:8b958afda69f29433e12fe131af49bc3ecd2008e pr:#211 INTEGRATED structure bridge bootstrap/contract as `BLOCKED_WSL_BOOTSTRAP`/`BLOCKED_HARNESS_CONTRACT` exits 51/52 and late interop harness/gh as 48/45; prior merge:0b13f9aa178bb927e74d024a577d54aae68f8050 pr:#207 exit-44 Admin Box surface; cloud ContractOnly PASS / live exit 46 STATUS=BLOCKED_WINDOWS_WSL_REQUIRED PROOF_LEVEL=LIVE_ATTEMPT_FAIL_CLOSED on tip `8b958af`; workers=0; LIVE_RUNTIME_PROOF:UNPROVEN — Admin Box Windows+wsl.exe+Ubuntu required
