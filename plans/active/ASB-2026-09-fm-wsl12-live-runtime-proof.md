...
Hosted/contract + structured cloud fail-closed (`WINDOWS_WSL_REQUIRED` / exit 46) are below physical PASS. Repository discovery hardening through PR #206 and exit-44 Admin Box surface through PR #207 prove selection/path integrity and deterministic blocker routing only. Physical PASS still requires Admin Box observation of the behavior chain, not command ACK alone.
